...
qiime dada2 denoise-paired \
        --i-demultiplexed-seqs $input/test-syncom1-demultiplexed-samples.qza \
        --p-n-threads 0 \
        --p-trunc-len-f 240 \
        --p-trunc-len-r 200 \
        --p-chimera-method pooled \
        --verbose \
        --o-table $output/test-table-dada2.qza \
        --o-representative-sequences $output/test-rep-seqs.qza \
        --o-denoising-stats $output/test-stats-dada2.qza